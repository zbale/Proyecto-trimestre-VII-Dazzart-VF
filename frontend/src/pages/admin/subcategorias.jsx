...
export default function SubcategoriasAdmin() {
  ...
  const cargarCategorias = async () => {
    try {
  const res = await axios.get(`${API_URL}/categorias/listar`);
  ...
  const cargarSubcategorias = () => {
    axios
      .get(`${API_URL}/subcategorias/listar`)
      .then((res) => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
  await axios.post(`${API_URL}/subcategorias/agregar`, form);
  ...
  const eliminarSubcategoria = async (id) => {
    ...
    try {
  const response = await axios.delete(`${API_URL}/subcategorias/eliminar/${id}`);
  ...
  const guardarEdicion = async (e) => {
    ...
    try {
      await axios.put(`${API_URL}/subcategorias/editar/${id_subcategoria}`, {
        nombre_subcategoria,
        descripcion_subcategoria,
        id_categoria,
      });
